...
CREATE PROCEDURE [dbo].[sp_Get_Amount_FAB3_Chemical_Na2S]
...
BEGIN
	...
	--exhs
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F365L_EXH_SEX_LT_201',1,3,@MAmount_T1 OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F365L_EXH_SEX_LT_201_D',2,3,@MAmount_T1A OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F365L_EXH_SEX_LT_201_COFF',5,3,@MAmount_T1C OUTPUT;
