...
CREATE PROCEDURE [dbo].[sp_Get_Amount_FABC_Chemical_HCl_GAS]
	@CalcDate AS DATE --重新指定運算日期
AS
BEGIN
	
	SET NOCOUNT ON;
	--DECLARE @CalcDate AS DATE ='2024-03-18'
	DECLARE @StartDate AS DATE 
	DECLARE @M_SEQ_ID_W int
	DECLARE @Plant varchar(50) ='FABC';
	DECLARE @CName varchar(50) ='HCl_氣化課';
	DECLARE @MB_Shop varchar(50) ='氣化課';
	DECLARE @MB_Sysname varchar(50) ='HFSS';
	DECLARE @tagName varchar(50) ='K93_CHEM_HCL_PIW_520';
	...
	SET @MAmount = ISNULL(@MAmount_T1, 0) * @M_WeightTransferPara;
