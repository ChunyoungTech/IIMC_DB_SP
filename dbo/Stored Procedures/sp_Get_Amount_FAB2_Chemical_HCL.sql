...
CREATE PROCEDURE [dbo].[sp_Get_Amount_FAB2_Chemical_HCL]
...
BEGIN
	...
	--取得總用量
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W_WWTS,'F2C10_UPWS_HCL_MBLIT401',1,0,@MAmount_T1 OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W_WWTS,'F2C10_UPWS_HCL_MBLIT401_D',2,3,@MAmount_T1A OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W_WWTS,'F2C10_UPWS_HCL_MBLIT401_COEF',5,3,@MAmount_T1C OUTPUT;

	EXEC sp_Get_FT_Amount @M_SEQ_ID_W_WWTS,'F2C10_UPWS_HCL_MBLIT402',1,0,@MAmount_T2 OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W_WWTS,'F2C10_UPWS_HCL_MBLIT402_D',2,3,@MAmount_T2A OUTPUT;
	...
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W_WWTS,'F2WB1_WWTS_HCL_D2006CM',1,0,@MAmount_T3 OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W_WWTS,'F2WB1_WWTS_HCL_D2006CM_D',2,3,@MAmount_T3A OUTPUT;
