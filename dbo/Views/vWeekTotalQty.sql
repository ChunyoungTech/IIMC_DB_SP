...
SELECT          A.M_Seq_ID, A.M_Date, d.MB_Plant, d.MB_Shop, d.MB_Sysname, d.MB_CName, CONVERT(VARCHAR(10), 
                            ...
                            DATEADD(DD, - 6, A.M_Date), 120) AS beforday5, A.M_TotalQty, ISNULL
                                ((SELECT          M_TotalQty
...
FROM              dbo.Material_Table AS A INNER JOIN
                            dbo.Material_Base_Data AS d ON A.MB_SEQ_ID = d.MB_Seq_ID AND d.MB_IsVisable = 'Y' AND d.MB_IsMaster = 'Y'
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vWeekTotalQty';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vWeekTotalQty';
