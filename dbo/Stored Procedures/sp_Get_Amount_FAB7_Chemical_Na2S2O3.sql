...
CREATE PROCEDURE [dbo].[sp_Get_Amount_FAB7_Chemical_Na2S2O3]
...
BEGIN
	...
	DECLARE @CName varchar(50) ='硫代硫酸鈉';
	DECLARE @MB_Shop varchar(50) ='水務課';
	DECLARE @MB_Sysname varchar(50) ='WWTS';
	DECLARE @tagName varchar(50) ='F7C10R_DIWT_LIT_951_PV';
	...
	--取得總用量
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7C10R_DIWT_LIT_951_PV',1,0,@MAmount_T1 OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7C10R_DIWT_LIT_951_PV_D',2,3,@MAmount_T1A OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7C10R_DIWT_LIT_951_PV_COEF',5,3,@MAmount_T1C OUTPUT;
