...
-- =============================================
CREATE PROCEDURE [dbo].[sp_ReportDayAmount_price]
...
FROM 
(
  SELECT MT.MB_SEQ_ID,MB_IsVisable,MB_Plant,MB_Shop,MB_Sysname,MB_CName,MB_UNIT,M_Date,(M_Amount*M_Price) as M_Amount,MB_DECIMAL_BITS FROM Material_Table as MT inner join Material_Base_Data as MB on MT.MB_SEQ_ID = MB.MB_SEQ_ID
) AS j
