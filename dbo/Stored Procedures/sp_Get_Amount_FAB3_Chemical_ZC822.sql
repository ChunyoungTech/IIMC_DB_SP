...
CREATE PROCEDURE [dbo].[sp_Get_Amount_FAB3_Chemical_ZC822]
...
BEGIN
	...
	--exhs
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F320F_OCA231_LT',1,0,@MAmount_T1 OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F320F_OCA231_LT_D',2,3,@MAmount_T1A OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F320F_OCA231_LT_COFF',5,3,@MAmount_T1C OUTPUT;
