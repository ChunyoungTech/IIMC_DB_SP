...
-- =============================================
CREATE PROCEDURE [dbo].[sp_ReportMonthFill]
...
FROM 
(
  select MMA.MB_SEQ_ID,MB_IsVisable,MB_Plant,MB_Shop,MB_Sysname,MB_CName,MB_UNIT,MMA_YM,M_FillingQty,MB.MB_DECIMAL_BITS,MB_IsFilling from vMeterial_Month_Amount as MMA inner join Material_Base_Data as MB on MMA.MB_SEQ_ID = MB.MB_SEQ_ID
) AS j
