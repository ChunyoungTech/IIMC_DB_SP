...
CREATE PROCEDURE [dbo].[sp_Get_Amount_FABC_Chemical_polymer_water]
...
BEGIN
	...
	DECLARE @CName varchar(50) ='Polymer陰性_水棟';
	DECLARE @MB_Shop varchar(50) ='水務課';
	DECLARE @MB_Sysname varchar(50) ='WWTB';
	DECLARE @tagName varchar(50) ='L2C3W10W_WWTS_LIA_1607_PV';
