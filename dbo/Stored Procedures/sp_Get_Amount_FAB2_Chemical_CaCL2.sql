...
CREATE PROCEDURE [dbo].[sp_Get_Amount_FAB2_Chemical_CaCL2]
...
BEGIN
	...
	--取得總用量
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W_WWTS,'F2W10_FTSS_CACL2_LIT24PVCM',1,0,@MAmount_T1 OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W_WWTS,'F2W10_FTSS_CACL2_LIT24PVCM_D',2,3,@MAmount_T1A OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W_WWTS,'F2W10_FTSS_CACL2_LIT24PVCM_COEF',5,3,@MAmount_T1C OUTPUT;

	SELECT @MAmount_T1,@MAmount_T1A,@MAmount_T1C,@M_WeightTransferPara,@M_FillingQty;
