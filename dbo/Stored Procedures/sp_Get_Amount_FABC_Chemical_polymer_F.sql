...
CREATE PROCEDURE [dbo].[sp_Get_Amount_FABC_Chemical_polymer_F]
...
BEGIN
	...
	DECLARE @CName varchar(50) ='Polymer陰性_F系';
	DECLARE @MB_Shop varchar(50) ='水務課';
	DECLARE @MB_Sysname varchar(50) ='FTSS';
	DECLARE @tagName varchar(50) ='L2K93W10A_WWTS_LIA_203_PV';
