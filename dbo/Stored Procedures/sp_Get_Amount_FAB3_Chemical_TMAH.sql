...
CREATE PROCEDURE [dbo].[sp_Get_Amount_FAB3_Chemical_TMAH]
...
BEGIN
	...
	DECLARE @CName varchar(50) ='TMAH';
	DECLARE @MB_Shop varchar(50) ='水務課';
	DECLARE @MB_Sysname varchar(50) ='TMAH';
	DECLARE @tagName varchar(50) ='F3CB1D_WTM_LIT_T12_PV';
