...
CREATE PROCEDURE [dbo].[sp_Get_Amount_FAB7_Chemical_NegativePolymer]
	@CalcDate AS DATE --重新指定運算日期
AS
BEGIN
	
	SET NOCOUNT ON;
	--DECLARE @CalcDate AS DATE ='2024-06-04'
	DECLARE @StartDate AS DATE 
	DECLARE @M_SEQ_ID_W int
	DECLARE @Plant varchar(50) ='FAB7';
	DECLARE @CName varchar(50) ='Polymer陰性';
	...
	--取得總用量
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7CB1R_WWTS_LIT_711_PV',1,0,@MAmount_T1 OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7CB1R_WWTS_LIT_711_PV_D',2,3,@MAmount_T1A OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7CB1R_WWTS_LIT_711_PV_COEF',5,3,@MAmount_T1C OUTPUT;

	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7CB1R_WWTS_LIT_712A_PV',1,0,@MAmount_T2 OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7CB1R_WWTS_LIT_712A_PV_D',2,3,@MAmount_T2A OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7CB1R_WWTS_LIT_712A_PV_INN',3,3,@MAmount_T2B OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7CB1R_WWTS_LIT_712A_PV_DF',4,3,@MAmount_T2C OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7CB1R_WWTS_LIT_712A_PV_COEF',5,3,@MAmount_T2D OUTPUT;
	SET @MAmount_T2=@MAmount_T2+@MAmount_T2B

	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7CB1R_WWTS_LIT_712B_PV',1,0,@MAmount_T3 OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7CB1R_WWTS_LIT_712B_PV_D',2,3,@MAmount_T3A OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7CB1R_WWTS_LIT_712B_PV_INN',3,3,@MAmount_T3B OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7CB1R_WWTS_LIT_712B_PV_DF',4,3,@MAmount_T3C OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7CB1R_WWTS_LIT_712B_PV_COEF',5,3,@MAmount_T3D OUTPUT;
	SET @MAmount_T3=@MAmount_T3+@MAmount_T3B
	...
	--SELECT @MAmount,@MAmount2,@MAmount3
