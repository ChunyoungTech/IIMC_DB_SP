...
CREATE PROCEDURE [dbo].[sp_Get_Amount_FAB7_Chemical_ZC822]
...
BEGIN
	...
	DECLARE @MB_Sysname varchar(50) ='CHST';
	...
	--exhs
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7CR1R_CHST_ZC822',1,0,@MAmount_T1 OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7CR1R_CHST_ZC822_D',2,3,@MAmount_T1A OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7CR1R_CHST_ZC822_COEF',5,3,@MAmount_T1C OUTPUT;
