CREATE VIEW dbo.v_CoefficientTemp
AS
...
WHERE     (dbo.IDMC_Table_Temp.TM_TYPE_OF = 2) AND (dbo.Material_Base_Data.MB_IsManual = 'Y')
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'v_CoefficientTemp';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'v_CoefficientTemp';
