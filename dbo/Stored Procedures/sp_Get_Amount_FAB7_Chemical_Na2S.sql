...
CREATE PROCEDURE [dbo].[sp_Get_Amount_FAB7_Chemical_Na2S]
...
BEGIN
	...
	--exhs
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7G40W_EXHS_NA2S_USAGE',1,3,@MAmount_T1 OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7G40W_EXHS_NA2S_USAGE_D',2,3,@MAmount_T1A OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W,'F7G40W_EXHS_NA2S_USAGE_COEF',5,3,@MAmount_T1C OUTPUT;
