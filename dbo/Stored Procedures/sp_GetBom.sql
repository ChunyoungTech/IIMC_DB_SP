...
-- =============================================
CREATE PROCEDURE [dbo].[sp_GetBom]
...
BEGIN
	...
	FROM [vBOM_USEAGE] where [BU_Date] >= @StartDate and [BU_Date] <= @EndDate
	...
	SET @sql = N' SELECT * FROM(
		SELECT BU_DATE,MB_Plant,MB_Shop,MB_Sysname,MB_CName,BS_TAG,BS_BOM_NO,BS_UNIT,BU_USEAGE,MB_DECIMAL_BITS FROM view_BOM_USEAGE
	) AS BU
	PIVOT
	(
		SUM(BU_USEAGE)
