...
CREATE PROCEDURE [dbo].[sp_Get_Amount_FAB2_Chemical_DEFOAMER]
...
BEGIN
	...
	--取得總用量
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W_WWTS,'F2W10_WWTS_DEFOAMER_D2064CM',1,0,@MAmount_T1 OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W_WWTS,'F2W10_WWTS_DEFOAMER_D2064CM_D',2,3,@MAmount_T1A OUTPUT;
	EXEC sp_Get_FT_Amount @M_SEQ_ID_W_WWTS,'F2W10_WWTS_DEFOAMER_D2064CM_COEF',5,3,@MAmount_T1C OUTPUT;
